            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Member since {{Auth::user()->created_at}} </small>@endif
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
              ...
              <!-- Menu Footer-->
              <li class="user-footer">@if(Auth::check())
                <div class="pull-left">
                  <a href="#" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right"> 
                  <a href="{{route('LogoutAd')}}" class="btn btn-default btn-flat">Sign out</a>
                </div>@endif
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Cỡ</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('AddSize')}}"><i class="fa fa-circle-o"></i> Thêm cỡ</a></li>
            <li><a href="{{route('ListSize')}}"><i class="fa fa-circle-o"></i> Danh sách cỡ</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('AddColors')}}"><i class="fa fa-circle-o"></i> Thêm màu sắc</a></li>
            <li><a href="{{route('ListColors')}}"><i class="fa fa-circle-o"></i> Danh sách màu sắc</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('AddBrand')}}"><i class="fa fa-circle-o"></i> Thêm thương hiệu</a></li>
            <li><a href="{{route('ListBrand')}}"><i class="fa fa-circle-o"></i> Danh sách thương hiệu</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class=""><a href="{{route('addCategory')}}"><i class="fa fa-circle-o"></i>Thêm danh mục</a></li>
            <li><a href="{{route('listCategory')}}"><i class="fa fa-circle-o"></i>Hiển thị danh mục</a></li><!-- 
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('AddProduct')}}"><i class="fa fa-circle-o"></i> Thêm sản phẩm</a></li>
            <li><a href="{{route('ListProduct')}}"><i class="fa fa-circle-o"></i> Danh sách sản phẩm</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Kiểu</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('AddStyle')}}"><i class="fa fa-circle-o"></i> Thêm kiểu</a></li>
            <li><a href="{{route('ListStyle')}}"><i class="fa fa-circle-o"></i> Danh sách kiểu</a></li>
          </ul>
        </li>
        <li class="">
          <a href="{{route('Statistical')}}">
            <i class="fa fa-folder"></i> <span>Thống kê</span>
          </a>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-share"></i> <span>Đăng nhập</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('LoginAd')}}"><i class="fa fa-circle-o"></i> Login</a></li>
            <li class="treeview">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Bạn chưa đăng nhập</p>

    <form action="{{route('LoginAd')}}" method="">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-12">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Tới trang đăng nhập</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<!-- 
    ...
    <a href="{{URL::to('RegisterAd')}}" class="text-center"><p class="login-box-msg">Tạo tài khoản mới</p></a>
