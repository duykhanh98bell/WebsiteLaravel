		...
		<form role="form" method="post" action="">
			...
			<div class="box-body">
				<div class="form-group">
					<label for="exampleInputEmail1">Sửa màu</label>
					<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập thương hiệu" name="colors_name" value="{{$ViewColors->colors_name}}">
				</div>
