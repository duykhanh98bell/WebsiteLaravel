        					...
        					<table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
        						<thead>
        							<tr role="row">
        								...
        								<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 910px;">Tên màu</th>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 910px;">Tùy chọn</th>
        						...
        						<tbody>
        							...
        							<tr role="row" class="odd">
        								...
        								<td>{{$cl->colors_name}}</td>
        								<td>{{$cl->created_at}}</td>
        								<td>{{$cl->updated_at}}</td>
                                        <td>
                                          <a href="{{URL::to('EditColors/'.$cl->colors_id)}}">Sửa</a>
                                          <a onclick="return confirm('xác nhận xóa danh mục ')" href="{{URL::to('DeleteColors/'.$cl->colors_id)}}">Xóa</a>
                                        </td>
        							</tr>
        							@endforeach
        						</tbody>
