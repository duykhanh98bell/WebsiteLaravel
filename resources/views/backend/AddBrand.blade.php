		...
		<form role="form" method="post" action="">
			...
			<div class="box-body">
				<div class="form-group">
					<label for="exampleInputEmail1">Thêm Thương hiệu</label>
					<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập thương hiệu" name="brand_name">
				</div>
