		...
		<form role="form" method="post" action="">
			...
			<div class="box-body">
				<div class="form-group">
					<label for="exampleInputEmail1">Sửa Cỡ</label>
					<input type="number" class="form-control" id="exampleInputEmail1" placeholder="Nhập Size" name="size_numbers" value="{{$ViewSize->size_numbers}}">
				</div>
